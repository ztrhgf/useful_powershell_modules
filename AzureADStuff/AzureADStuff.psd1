...
FunctionsToExport = 'Connect-AzAccount2', 'Connect-AzureAD2', 'Connect-PnPOnline2', 
               'Get-AzureADAccountOccurrence', 'Get-AzureADAppConsentRequest', 
               'Get-AzureADRoleAssignments', 'Get-AzureDevOpsOrganizationOverview', 
               'Get-SharepointSiteOwner', 'Invoke-GraphAPIRequest', 
               'New-AzureDevOpsAuthHeader', 'New-GraphAPIAuthHeader', 
               'Open-AzureADAdminConsentPage'
