#
# Module manifest for module 'AzureApplicationStuff'
#
...
RootModule = 'AzureApplicationStuff.psm1'
...
FunctionsToExport = 'Add-AzureAppUserConsent', 'Get-AzureAppConsentRequest', 
               'Get-AzureAppRegistration', 'Get-AzureAppVerificationStatus', 
               'Get-AzureEnterpriseApplication', 'Get-AzureManagedIdentity', 
...
AliasesToExport = 'Get-AzureSPPermissions'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','PowerShell','Monitoring','Audit','Security','Graph'
