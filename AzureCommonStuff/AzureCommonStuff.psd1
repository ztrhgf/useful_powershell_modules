#
# Module manifest for module 'AzureCommonStuff'
#
...
FunctionsToExport = 'Connect-AzAccount2', 'Connect-PnPOnline2', 'FilterBy-AzureScope', 
               'Get-AuthenticatedSPIdentityAppId', 'Get-AzureDirectoryObject', 
               'Get-AzureDirectoryObjectMemberOf', 'Invoke-AzureBatchRequest', 
               'New-AzureBatchRequest', 'New-AzureDevOpsAuthHeader', 
               'Start-AzureSync'
...
AliasesToExport = 'Get-AzureAccountMemberOf', 'Get-AzureAccountPermanentMemberOf', 
               'Start-AzureADSync', 'Sync-ADtoAzure'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'Azure','AzureCommonStuff','PowerShell','Monitoring','Audit','Security','Graph','Runbook','Batch','ARM','Batching','ARG'
        ...
        ReleaseNotes = '
            1.0.14
                FIXED
                    Invoke-AzureBatchRequest - fixed batch request flattening when invoked in pipeline
            1.0.13
                CHANGED
                    New-AzureBatchRequest - replaced all aliases with cmdlet full names
                    Invoke-AzureBatchRequest - replaced all aliases with cmdlet full names
                                             - flattening of the given BatchRequest object before processing
            1.0.12
                FIXED
