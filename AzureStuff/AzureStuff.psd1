...
'
    ...
    RequiredModules   = @('AzureCommonStuff', 'AzureOtherStuff', 'AzureApplicationStuff', 'AzureDeviceStuff', 'AzureGroupStuff', 'AzureResourceStuff', 'AzureRoleStuff', 'AzureUserStuff')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            * 2.0.0
                * BREAKING CHANGE
                splitting module to sub-modules
            '
