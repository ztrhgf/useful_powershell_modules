...
FunctionsToExport = 'Compare-Object2', 'ConvertFrom-HTMLTable', 'ConvertFrom-XML', 
               ...
               'Invoke-FileSystemWatcher', 'Invoke-MSTSC', 'Invoke-SQL', 
               'Invoke-WindowsUpdate', 'New-BasicAuthHeader', 'Publish-Module2', 
...
AliasesToExport = 'Create-BasicAuthHeader', 'Install-WindowsUpdate', 'Invoke-WU', 'rdp', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '
            ...
            * 1.0.15
                * CHANGED
                    * renamed Create-BasicAuthHeader to New-BasicAuthHeader to avoid unaproved verb warning (Create-BasicAuthHeader is now alias)
            '
