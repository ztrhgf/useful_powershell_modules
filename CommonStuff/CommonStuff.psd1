...
FunctionsToExport = 'Compare-Object2', 'ConvertFrom-CompressedString', 
               'ConvertFrom-EncryptedString', 'ConvertFrom-HTMLTable', 
               'ConvertFrom-XML', 'ConvertTo-CompressedString', 
               'ConvertTo-EncryptedString', 'Expand-ObjectProperty', 
               'Export-ScriptsToModule', 'Get-InstalledSoftware', 
               'Get-PSHScriptBlockLoggingEvent', 'Get-SFCLogEvent', 
               'Invoke-AsLoggedUser', 'Invoke-AsSystem', 'Invoke-FileContentWatcher', 
               'Invoke-FileSystemWatcher', 'Invoke-MSTSC', 'Invoke-RestMethod2', 
               'Invoke-SQL', 'Invoke-WindowsUpdate', 'New-BasicAuthHeader', 
               'Publish-Module2', 'Quote-String', 'Read-FromClipboard', 
               'Send-EmailViaSendGrid', 'Uninstall-ApplicationViaUninstallString'
...
AliasesToExport = 'ConvertFrom-Clipboard', 'ConvertTo-QuotedString', 
               'Create-BasicAuthHeader', 'Install-WindowsUpdate', 'Invoke-WU', 'rdp', 
               'Watch-FileContent', 'Watch-FileSystem'
        ...
        ReleaseNotes = '
            1.0.24
                ADDED
                    ...
                    ConvertFrom-EncryptedString - decrypts an AES-encrypted string back to plaintext
                CHANGED
                    Compare-Object2 - supports empty inputs comparison
                    Quote-String - better delimiter handling
            1.0.23
                ADDED
