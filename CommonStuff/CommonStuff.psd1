...
FunctionsToExport = 'ConvertFrom-HTMLTable', 'ConvertFrom-XML', 'Create-BasicAuthHeader', 
               'Export-ScriptsToModule', 'Get-InstalledSoftware', 'Get-SFCLogEvent', 
               'Invoke-AsLoggedUser', 'Invoke-AsSystem', 'Invoke-FileContentWatcher', 
               'Invoke-FileSystemWatcher', 'Invoke-MSTSC', 'Invoke-SQL', 
               'Invoke-WindowsUpdate', 'Uninstall-ApplicationViaUninstallString'
