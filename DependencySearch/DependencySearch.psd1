#
# Module manifest for module 'PSGet_DependencySearch'
#
...
FunctionsToExport = 'Get-AddPSSnapinFromAST', 'Get-CodeDependency', 
               'Get-CodeDependencyStatus', 'Get-CorrespondingGraphCommand', 
               'Get-ImportModuleFromAST', 'Get-ModuleCommandUsedInCode'
...
AliasesToExport = 'Get-Dependency', 'Get-PSHCodeDependency'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PowerShell','Dependency','AST'
