...
AliasesToExport = 'Connect-MSGraphApp2', 'Get-IntuneAccountPolicyAssignment', 
               'Get-IntuneAuthHeader', 'Get-IntuneClientPolicyResult', 
               'Get-IntuneJoinStatus', 'Get-IntunePolicyResult', 
               'Invoke-IntuneEnrollmentRepair', 'Invoke-IntuneEnrollmentReset', 
               'Invoke-IntuneReenrollment', 'Invoke-IntuneScriptRedeployLocally', 
               'Invoke-IntuneWin32AppRedeployLocally', 'ipresult', 
               'New-IntuneAuthHeader', 'New-MgAuthHeader', 'Repair-IntuneEnrollment', 
               'Reset-IntuneJoin', 'Search-IntuneAccountAppliedPolicy'
