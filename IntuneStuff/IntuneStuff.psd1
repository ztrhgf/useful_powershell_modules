...
FunctionsToExport = 'Compare-IntuneSecurityBaseline', 'ConvertFrom-MDMDiagReport', 
               ...
               'Get-IntuneDeviceAutopilotHashViaRemediation', 
               'Get-IntuneDeviceComplianceStatus', 'Get-IntuneDeviceHardware', 
               'Get-IntuneDeviceOnDemandProactiveRemediationStatus', 
               'Get-IntuneDiscoveredApp', 'Get-IntuneEnrollmentStatus', 
               ...
               'Get-IntuneRemediationResult', 'Get-IntuneRemediationScriptLocally', 
               ...
               'Invoke-IntuneCommand', 'Invoke-IntuneRemediationOnDemand', 
               'Invoke-IntuneScriptRedeploy', 'Invoke-IntuneWin32AppAssignment', 
               'Invoke-IntuneWin32AppRedeploy', 'Invoke-MDMReenrollment', 
               'Invoke-ReRegisterDeviceToIntune', 'New-IntuneRemediation', 
               'Remove-IntuneRemediation', 'Remove-IntuneWin32AppAssignment', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '
            1.7.1
                ADDED
                    Get-IntuneDeviceAutopilotHashViaRemediation - gets Autopilot hash via Intune remediation script
                FIXED
                    Invoke-IntuneWin32AppAssignment, Remove-IntuneWin32AppAssignment - Get-MgDeviceAppMgtMobileApp replaced for Get-MgDeviceAppManagementMobileApp
                CHANGED
                    Upload-IntuneAutopilotHash - added parameter SkipSync
                    Get-IntuneConfPolicyAssignmentSummaryReport -added support for Windows81AndLater platform
                    Get-BitlockerEscrowStatusForAzureADDevices - returns also enrolledDateTime property
            1.7.0
                ADDED
