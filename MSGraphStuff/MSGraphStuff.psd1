...
FunctionsToExport = 'Expand-MgAdditionalProperties', 'Invoke-GraphAPIRequest', 
...
AliasesToExport = 'Get-IntuneAuthHeader', 'Invoke-MgRequest', 'New-IntuneAuthHeader', 
               'New-MgAuthHeader'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'PowerShell','Graph','Microsoft','API','MSGraph'
