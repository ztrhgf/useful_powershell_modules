...
FunctionsToExport = 'Expand-MgAdditionalProperties', 
...
AliasesToExport = 'Get-CodeGraphPermission', 'Get-CodeGraphScope', 
               'Get-GraphAPICodePermission', 'Get-GraphAPICodeScope', 
               'Get-IntuneAuthHeader', 'Invoke-MgRequest', 'New-IntuneAuthHeader', 
               'New-MgAuthHeader'
