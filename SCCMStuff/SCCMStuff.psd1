#
# Module manifest for module 'PSGet_SCCMStuff'
#
...
FunctionsToExport = 'Add-CMDeviceToCollection', 'Clear-CMClientCache', 'Connect-SCCM', 
               ...
               'Get-CMCollectionComplianceStatus', 'Get-CMCollectionOGV', 
               'Get-CMComputerCollection', 'Get-CMComputerComplianceStatus', 
               'Get-CMDeploymentStatus', 'Get-CMLog', 'Invoke-CMAdminServiceQuery', 
               'Invoke-CMAppInstall', 'Invoke-CMClientReinstall', 
               'Invoke-CMComplianceEvaluation', 'New-CMAppDeployment', 
               'New-CMAppPhasedDeploment', 'New-CMDevice', 'Refresh-CMCollection', 
               'Set-CMDeviceDJoinBlobVariable', 'Set-CMDeviceSerialNumber', 
