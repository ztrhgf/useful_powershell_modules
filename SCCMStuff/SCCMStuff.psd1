#
# Module manifest for module 'SCCMStuff'
#
...
FunctionsToExport = 'Add-CMDeviceToCollection', 'Clear-CMClientCache', 'Connect-SCCM', 
               'Get-CMAppDeploymentStatus', 'Get-CMApplicationOGV', 
               'Get-CMAutopilotHash', 'Get-CMCollectionComplianceStatus', 
               'Get-CMCollectionOGV', 'Get-CMComputerCollection', 
               'Get-CMComputerComplianceStatus', 'Get-CMDeploymentStatus', 
               'Get-CMLog', 'Invoke-CMAdminServiceQuery', 'Invoke-CMAppInstall', 
               'Invoke-CMClientReinstall', 'Invoke-CMComplianceEvaluation', 
               'New-CMAppDeployment', 'New-CMAppPhasedDeploment', 'New-CMDevice', 
               'Refresh-CMCollection', 'Set-CMDeviceDJoinBlobVariable', 
               'Set-CMDeviceSerialNumber', 'Update-CMAppSourceContent', 
               'Update-CMClientPolicy'
...
AliasesToExport = 'Invoke-CMAppDeployment', 'Invoke-CMAppPhasedDeployment', 
               'Invoke-CMClientPolicyUpdate', 'Set-CMDeviceServiceTag'
